...
<?php
 ...
 $link= mysqli_connect("localhost", "root","","demo");
    ...
    $query = "SELECT * FROM `booking`,`user` WHERE booking.`u_id`=user.`id` AND `pid`='".mysqli_real_escape_string($link, $_POST['pid'])."'";
    ...
    <th>NO. OF PASSENGERS</th>
        ...
        echo"<tr>";
        echo"<td>{$row['name']}</td><td>{$row['mail']}</td><td>{$row['phno']}</td><td>{$row['no_pass']}</td>";
        echo"</tr>";
    }
