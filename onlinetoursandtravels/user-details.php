    ...
    if(array_key_exists("mail",$_POST) OR array_key_exists("password",$_POST)  OR array_key_exists("name",$_POST) OR array_key_exists("phno",$_POST) ){
         ...
         if ($_POST['name'] == '') {
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                $query2 = "INSERT INTO `user` (`mail`, `password`,`name`,`phno`) VALUES ('".mysqli_real_escape_string($link, $_POST['mail'])."', '".mysqli_real_escape_string($link, $_POST['password'])."','".mysqli_real_escape_string($link, $_POST['name'])."','".mysqli_real_escape_string($link, $_POST['phno'])."')";
...
<body>
    ...
    <div id="bord">
    <div id="img">
            <img src="user-detail.webp" width="550px" height="410px">
        </div>
     <div id="class">
    <form method="post" action="user-details.php">
           ...
           <p>  USER PHONE-NO.:
           <br> <input type="number" name ="phno" class="box" placeholder="user ph no." required> </p>
